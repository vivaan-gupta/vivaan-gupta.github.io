...
- <a id="connected-set"></a> **Connected Set** : Let $$(X, d)$$ be a metric space, then $$Y\subseteq X$$ is a connected set if and only if the metric space $$(Y, d_{Y\times Y})$$ is [connected](#connected-space)
